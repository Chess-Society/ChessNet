...
declare module "$app/types" {
	export interface AppTypes {
		...
		Pathname(): "/" | "/api" | "/api/" | "/api/attendance" | "/api/attendance/" | "/api/auth" | "/api/auth/" | "/api/auth/session" | "/api/auth/session/" | "/api/check-auth" | "/api/check-auth/" | "/api/class-skills" | "/api/class-skills/" | "/api/class-students" | "/api/class-students/" | "/api/classes" | "/api/classes/" | `/api/classes/${string}` & {} | `/api/classes/${string}/` & {} | "/api/health-check" | "/api/health-check/" | "/api/payments" | "/api/payments/" | "/api/schools" | "/api/schools/" | `/api/schools/${string}` & {} | `/api/schools/${string}/` & {} | "/api/skills" | "/api/skills/" | "/api/students" | "/api/students/" | `/api/students/${string}` & {} | `/api/students/${string}/` & {} | "/api/subscriptions" | "/api/subscriptions/" | "/api/tournaments" | "/api/tournaments/" | "/api/whoami" | "/api/whoami/" | "/attendance" | "/attendance/" | "/auth" | "/auth/" | "/classes" | "/classes/" | "/classes/create" | "/classes/create/" | `/classes/${string}` & {} | `/classes/${string}/` & {} | `/classes/${string}/attendance` & {} | `/classes/${string}/attendance/` & {} | `/classes/${string}/edit` & {} | `/classes/${string}/edit/` & {} | `/classes/${string}/skills` & {} | `/classes/${string}/skills/` & {} | `/classes/${string}/students` & {} | `/classes/${string}/students/` & {} | "/dashboard-success" | "/dashboard-success/" | "/dashboard-temp" | "/dashboard-temp/" | "/dashboard" | "/dashboard/" | "/debug-auth" | "/debug-auth/" | "/debug" | "/debug/" | "/legal" | "/legal/" | "/legal/cookies" | "/legal/cookies/" | "/legal/privacy" | "/legal/privacy/" | "/legal/terms" | "/legal/terms/" | "/login-success" | "/login-success/" | "/login" | "/login/" | "/payments" | "/payments/" | "/payments/create" | "/payments/create/" | "/reports" | "/reports/" | `/reports/${string}` & {} | `/reports/${string}/` & {} | "/schools" | "/schools/" | "/schools/create" | "/schools/create/" | `/schools/${string}` & {} | `/schools/${string}/` & {} | `/schools/${string}/edit` & {} | `/schools/${string}/edit/` & {} | `/schools/${string}/lessons` & {} | `/schools/${string}/lessons/` & {} | `/schools/${string}/tournaments` & {} | `/schools/${string}/tournaments/` & {} | "/skills" | "/skills/" | "/skills/create" | "/skills/create/" | `/skills/${string}` & {} | `/skills/${string}/` & {} | `/skills/${string}/edit` & {} | `/skills/${string}/edit/` & {} | "/students" | "/students/" | "/students/create" | "/students/create/" | `/students/${string}` & {} | `/students/${string}/` & {} | `/students/${string}/edit` & {} | `/students/${string}/edit/` & {} | "/tournaments" | "/tournaments/" | "/tournaments/create" | "/tournaments/create/" | `/tournaments/${string}` & {} | `/tournaments/${string}/` & {} | `/tournaments/${string}/edit` & {} | `/tournaments/${string}/edit/` & {} | "/upgrade" | "/upgrade/";
