...
let mockClassSkills = [
  ...
  { id: "csk-1", class_id: "mock-class-1", skill_id: "mock-skill-1", owner_id: "dev-user-123", assigned_at: "2024-01-15T10:00:00Z", active: true, order: 1 },
  // Movimiento de Peones
  { id: "csk-2", class_id: "mock-class-1", skill_id: "mock-skill-2", owner_id: "dev-user-123", assigned_at: "2024-01-20T10:00:00Z", active: true, order: 2 },
  // Enroque
  // Intermedios Tarde (mock-class-2) - Skills intermedias
  { id: "csk-3", class_id: "mock-class-2", skill_id: "mock-skill-2", owner_id: "dev-user-123", assigned_at: "2024-01-10T17:00:00Z", active: true, order: 1 },
  // Enroque
  { id: "csk-4", class_id: "mock-class-2", skill_id: "mock-skill-3", owner_id: "dev-user-123", assigned_at: "2024-01-15T17:00:00Z", active: true, order: 2 },
  // Táctica: Clavada
  { id: "csk-5", class_id: "mock-class-2", skill_id: "mock-skill-4", owner_id: "dev-user-123", assigned_at: "2024-01-20T17:00:00Z", active: true, order: 3 },
  // Táctica: Tenedor
  // Avanzados Fin de Semana (mock-class-3) - Skills avanzadas
  { id: "csk-6", class_id: "mock-class-3", skill_id: "mock-skill-4", owner_id: "dev-user-123", assigned_at: "2024-01-05T09:00:00Z", active: true, order: 1 },
  // Táctica: Tenedor
  { id: "csk-7", class_id: "mock-class-3", skill_id: "mock-skill-5", owner_id: "dev-user-123", assigned_at: "2024-01-10T09:00:00Z", active: true, order: 2 },
  // Final: Rey y Torre vs Rey
  { id: "csk-8", class_id: "mock-class-3", skill_id: "mock-skill-6", owner_id: "dev-user-123", assigned_at: "2024-01-15T09:00:00Z", active: true, order: 3 },
  // Apertura: Italiana
  // Pequeños Ajedrecistas (mock-class-4) - Skills básicas adaptadas
  { id: "csk-9", class_id: "mock-class-4", skill_id: "mock-skill-1", owner_id: "dev-user-123", assigned_at: "2024-02-10T16:00:00Z", active: true, order: 1 },
  // Movimiento de Peones
  // Jóvenes Talentos (mock-class-5) - Skills intermedias/avanzadas
  { id: "csk-10", class_id: "mock-class-5", skill_id: "mock-skill-3", owner_id: "dev-user-123", assigned_at: "2024-02-05T18:00:00Z", active: true, order: 1 },
  // Táctica: Clavada
  { id: "csk-11", class_id: "mock-class-5", skill_id: "mock-skill-4", owner_id: "dev-user-123", assigned_at: "2024-02-08T18:00:00Z", active: true, order: 2 },
  // Táctica: Tenedor
  { id: "csk-12", class_id: "mock-class-5", skill_id: "mock-skill-5", owner_id: "dev-user-123", assigned_at: "2024-02-12T18:00:00Z", active: true, order: 3 }
  // Final: Rey y Torre vs Rey
];
const GET = async ({ url }) => {
...
const PUT = async ({ request, url }) => {
  ...
  if (isLocalDev) {
    ...
    try {
      const body = await request.json();
      const { class_id, skills_order } = body;
