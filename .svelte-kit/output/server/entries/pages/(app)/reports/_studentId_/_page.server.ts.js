  ...
  if (isLocalDev) {
    ...
    const report = {
      ...
      progress_summary: {
        ...
        payment_compliance: studentPayments.length > 0 ? studentPayments.filter((p) => p.status === "paid").length / studentPayments.length * 100 : 0,
        ...
        highest_rating: 1220,
        lowest_rating: 1180,
        last_activity_date: (/* @__PURE__ */ new Date()).toISOString()
      },
      attendance_history: [
