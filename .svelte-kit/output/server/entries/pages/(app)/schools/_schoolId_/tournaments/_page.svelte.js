import { h as head, d as escape_html, j as bind_props, p as pop, k as push } from "../../../../../../chunks/index.js";
...
function _page($$payload, $$props) {
  ...
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Torneos - ChessNet</title>`;
  });
  ...
  Trophy($$payload, { class: "w-6 h-6 text-primary-500" });
  $$payload.out.push(`<!----> <div><h1 class="text-xl font-bold text-white">Torneos y Competiciones</h1> <p class="text-sm text-slate-400">Centro ID: ${escape_html(data.schoolId)}</p></div></div></div> <button class="btn-primary">`);
  Plus($$payload, { class: "w-4 h-4 mr-2" });
  $$payload.out.push(`<!----> Nuevo torneo</button></div></div></header> <main class="container mx-auto px-4 py-8"><div class="mb-8"><div class="bg-slate-800 rounded-2xl p-6 border border-slate-700"><div class="flex items-center space-x-3 mb-4"><div class="p-2 bg-blue-500/20 rounded-lg">`);
  ...
  Plus($$payload, { class: "w-4 h-4 mr-2" });
  $$payload.out.push(`<!----> Crear mi primer torneo</button> <button class="btn-secondary">`);
  Trophy($$payload, { class: "w-4 h-4 mr-2" });
  ...
  Trophy($$payload, { class: "w-6 h-6 text-primary-500" });
  $$payload.out.push(`<!----></div> <div><h3 class="font-semibold">Torneos Suizos</h3> <p class="text-sm text-slate-400">Sistema de emparejamiento automático</p></div></div></div> <div class="card hover:bg-slate-700 transition-colors"><div class="flex items-center space-x-4"><div class="p-3 bg-green-500/20 rounded-xl">`);
  Plus($$payload, { class: "w-6 h-6 text-green-500" });
  $$payload.out.push(`<!----></div> <div><h3 class="font-semibold">Torneos por Eliminación</h3> <p class="text-sm text-slate-400">Competiciones directas</p></div></div></div> <div class="card hover:bg-slate-700 transition-colors"><div class="flex items-center space-x-4"><div class="p-3 bg-yellow-500/20 rounded-xl">`);
