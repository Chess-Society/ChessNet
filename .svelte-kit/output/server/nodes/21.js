import * as server from '../entries/pages/(app)/schools/_schoolId_/lessons/_page.server.ts.js';

export const index = 21;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(app)/schools/_schoolId_/lessons/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/(app)/schools/[schoolId]/lessons/+page.server.ts";
