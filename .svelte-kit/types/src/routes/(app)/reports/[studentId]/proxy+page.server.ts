...
export const load = async ({ params, locals, url }: Parameters<PageServerLoad>[0]) => {
  ...
  if (isLocalDev) {
    ...
    // Mock de datos detallados por estudiante
      ...
      'mock-student-1': {
        ...
        activity_timeline: [
          ...
          },
          {
            ...
            status: 'positive',
            details: { amount: 45.00, method: 'Efectivo' }
          },
          {
            date: '2024-02-02',
            type: 'skill',
      ...
      'mock-student-2': {
        ...
        activity_timeline: [
          ...
          },
          {
            ...
            status: 'negative',
            details: { amount: 45.00, days_overdue: 3 }
          }
        ]
      }
    };

    const studentReport = mockStudentReports[studentId as keyof typeof mockStudentReports];
