	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/attendance/_server.ts.js'))
			},
			{
				id: "/api/auth/session",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/check-auth/_server.ts.js'))
			},
			{
				id: "/api/class-skills",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/class-skills/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/class-students/_server.ts.js'))
			},
			{
				id: "/api/classes",
				pattern: /^\/api\/classes\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/classes/_server.ts.js'))
			},
			{
				id: "/api/classes/[id]",
				pattern: /^\/api\/classes\/([^/]+?)\/?$/,
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/classes/_id_/_server.ts.js'))
			},
			{
				id: "/api/health-check",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/health-check/_server.ts.js'))
			},
			{
				id: "/api/payments",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/payments/_server.ts.js'))
			},
			{
				id: "/api/schools",
				pattern: /^\/api\/schools\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/schools/_server.ts.js'))
			},
			{
				id: "/api/schools/[id]",
				pattern: /^\/api\/schools\/([^/]+?)\/?$/,
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/schools/_id_/_server.ts.js'))
			},
			{
				id: "/api/skills",
				pattern: /^\/api\/skills\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/skills/_server.ts.js'))
			},
			{
				id: "/api/students",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/students/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/students/_studentId_/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/subscriptions/_server.ts.js'))
			},
			{
				id: "/api/tournaments",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/tournaments/_server.ts.js'))
			},
			{
				id: "/api/whoami",
				pattern: /^\/api\/whoami\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/whoami/_server.ts.js'))
			},
			{
				id: "/debug-auth",
				pattern: /^\/debug-auth\/?$/,
