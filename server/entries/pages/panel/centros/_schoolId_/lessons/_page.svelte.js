...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let data = $$props["data"];
    head("ulibfe", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Lecciones - ChessNet</title>`);
      });
    });
    ...
    Book_open($$renderer2, { class: "w-6 h-6 text-primary-500" });
    $$renderer2.push(`<!----> <div><h1 class="text-xl font-bold text-white">Lecciones y Ejercicios</h1> <p class="text-sm text-slate-400">Centro ID: ${escape_html(data.schoolId)}</p></div></div></div> <div class="flex items-center space-x-2"><button class="btn-secondary">`);
    Plus($$renderer2, { class: "w-4 h-4 mr-2" });
    $$renderer2.push(`<!----> Ejercicio</button> <button class="btn-secondary">`);
    Plus($$renderer2, { class: "w-4 h-4 mr-2" });
    $$renderer2.push(`<!----> Lección</button> <button class="btn-primary">`);
    Plus($$renderer2, { class: "w-4 h-4 mr-2" });
    $$renderer2.push(`<!----> Unidad</button></div></div></div></header> <main class="container mx-auto px-4 py-8"><div class="mb-8"><div class="bg-slate-800 rounded-2xl p-6 border border-slate-700"><div class="flex items-center space-x-3 mb-4"><div class="p-2 bg-blue-500/20 rounded-lg">`);
    ...
    Plus($$renderer2, { class: "w-4 h-4 mr-2" });
    $$renderer2.push(`<!----> Crear primera unidad</button> <button class="btn-secondary">`);
    Book_open($$renderer2, { class: "w-4 h-4 mr-2" });
    ...
    Book_open($$renderer2, { class: "w-6 h-6 text-primary-500" });
    $$renderer2.push(`<!----></div> <div><h3 class="font-semibold">Unidades de Contenido</h3> <p class="text-sm text-slate-400">Organiza lecciones por temas</p></div></div></div> <div class="card hover:bg-slate-700 transition-colors"><div class="flex items-center space-x-4"><div class="p-3 bg-green-500/20 rounded-xl">`);
    Plus($$renderer2, { class: "w-6 h-6 text-green-500" });
    $$renderer2.push(`<!----></div> <div><h3 class="font-semibold">Lecciones Interactivas</h3> <p class="text-sm text-slate-400">Crea contenido educativo</p></div></div></div> <div class="card hover:bg-slate-700 transition-colors"><div class="flex items-center space-x-4"><div class="p-3 bg-yellow-500/20 rounded-xl">`);
