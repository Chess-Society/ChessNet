...
<svelte:head>
  <title>Alta de Alumno - ChessNet</title>
</svelte:head>
  ...
  {#if classes.length === 0}
    <div class="bento-card border-dashed border-white/10 p-20 md:p-32 text-center space-y-10" in:fade>
      ...
      <div class="max-w-md mx-auto space-y-4">
        ...
        <p class="text-slate-500 font-jakarta text-lg font-medium leading-relaxed">No puedes matricular alumnos sin tener una clase activa en el sistema.</p>
      </div>
      <button 
      ...
      <div class="space-y-6">
        ...
        <div class="flex items-center gap-6">
          ...
          <div>
            ...
            <p class="text-slate-400 font-jakarta text-lg font-medium">Nueva alta en la comunidad.</p>
          </div>
        </div>
      </div>
    ...
    {#if isLimitReached}
      <div class="bento-card border-violet-500/50 p-10 flex flex-col md:flex-row items-center gap-8 mb-10 overflow-hidden relative shadow-violet-flare/20" in:fly={{ y: 20 }}>
        ...
        <div class="flex-grow text-center md:text-left relative z-10">
          ...
          <p class="text-slate-400 font-jakarta text-lg font-medium mt-1">Sube a Premium para gestionar alumnos ilimitados y desbloquear funciones avanzadas.</p>
        </div>
        <a 
          href="/panel/upgrade"
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div class="bento-card !p-10 space-y-12">
           <div class="flex items-center gap-4 pb-6 border-b border-white/5">
              ...
              <h2 class="text-xl font-outfit font-extrabold text-white tracking-tight">NOTAS Y EXPEDIENTE</h2>
           </div>
      ...
      <div class="space-y-8">
         <div class="bento-card !p-8 space-y-8 relative overflow-hidden group">
            ...
            <div class="flex items-center gap-3 relative z-10">
               ...
               <h3 class="text-sm font-outfit font-black text-white uppercase tracking-widest">PRO-TIPS</h3>
            </div>
            ...
            <div class="space-y-6 relative z-10">
               <div class="flex gap-4">
                  ...
                  <p class="text-xs font-jakarta font-medium text-slate-400 leading-relaxed">
                     El sistema generará una <span class="text-white">ficha técnica</span> personalizable tras el alta.
                  </p>
               </div>
               <div class="flex gap-4">
                  ...
                  <p class="text-xs font-jakarta font-medium text-slate-400 leading-relaxed">
                     Usa las <span class="text-white">notas</span> para documentar el ELO inicial del estudiante.
                  </p>
               </div>
               <div class="flex gap-4">
                  ...
                  <p class="text-xs font-jakarta font-medium text-slate-400 leading-relaxed">
                     Atajo: <kbd class="px-2 py-1 bg-white/5 rounded-md border border-white/10 text-white font-mono text-[9px]">CMD + Enter</kbd> para guardar.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="bento-card !p-8 space-y-6">
            ...
            <div class="p-6 bg-zinc-950 rounded-24 border border-white/5 space-y-5 relative overflow-hidden group">
               ...
               <div class="flex items-center gap-5 relative z-10">
                  <div class="w-14 h-14 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-violet-400 font-outfit font-extrabold text-xl shadow-inner">
                  ...
                  <div class="min-w-0">
                    ...
                    <p class="text-[9px] font-outfit font-black text-violet-500/60 uppercase tracking-widest mt-1">ChessNet Aspirante</p>
                  </div>
               </div>
            </div>
         </div>
