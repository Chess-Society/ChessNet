      ...
      <div class="flex items-center gap-8">
        ...
        <div>
          ...
          <div class="flex flex-wrap items-center gap-4 mt-3">
            ...
            {/if}
            <span class="flex items-center gap-2 text-[10px] font-black text-emerald-400 uppercase tracking-widest bg-emerald-500/10 px-4 py-1.5 rounded-full border border-emerald-500/20">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-8 rounded-[2rem] border-b-4 border-b-violet-500 shadow-xl group hover:-translate-y-1 transition-all duration-300">
      <div class="flex items-start justify-between mb-4">
        <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Clases Activas</p>
      ...
      <div class="flex items-baseline gap-2">
        ...
        <span class="text-[10px] font-bold text-zinc-600 uppercase">Grupos</span>
      </div>
    </div>
    ...
    <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-8 rounded-[2rem] border-b-4 border-b-blue-500 shadow-xl group hover:-translate-y-1 transition-all duration-300">
      <div class="flex items-start justify-between mb-4">
        <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Capacidad Est.</p>
      ...
      <div class="flex items-baseline gap-2">
        ...
        <span class="text-[10px] font-bold text-zinc-600 uppercase">Plazas</span>
      </div>
    </div>
    ...
    <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-8 rounded-[2rem] border-b-4 border-b-purple-500 shadow-xl group hover:-translate-y-1 transition-all duration-300">
      <div class="flex items-start justify-between mb-4">
        <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Diversidad</p>
      ...
      <div class="flex items-baseline gap-2">
        ...
        <span class="text-[10px] font-bold text-zinc-600 uppercase">Niveles</span>
      </div>
    </div>
    ...
    <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-8 rounded-[2rem] border-b-4 border-b-amber-500 shadow-xl group hover:-translate-y-1 transition-all duration-300">
      <div class="flex items-start justify-between mb-4">
        <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Rendimiento Avg</p>
      ...
      <div class="flex items-baseline gap-2">
        ...
        <span class="text-[10px] font-bold text-zinc-600 uppercase">Meta</span>
      </div>
    </div>
  </div>
    ...
    {#if filteredClasses.length === 0}
      <div class="bg-zinc-900/30 backdrop-blur-sm p-32 text-center space-y-8 rounded-[3rem] border border-dashed border-zinc-800">
        ...
        <div class="max-w-xs mx-auto space-y-4">
          <h3 class="text-lg font-outfit font-black text-white uppercase tracking-widest">Sin clases configuradas</h3>
          <p class="text-sm font-jakarta text-zinc-500 leading-relaxed">Empieza a organizar grupos de entrenamiento en este centro ahora.</p>
        </div>
        <button 
            ...
            <div>
              ...
              <div class="space-y-4 mb-10 relative z-10">
                <div class="flex items-center justify-between text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">
                  <span class="flex items-center gap-2"><Users size={16} weight="duotone" class="text-violet-500" /> Estudiantes</span>
