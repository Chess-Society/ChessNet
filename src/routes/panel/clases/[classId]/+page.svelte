        ...
        <div>
          <div class="flex items-center gap-3 mb-1">
             ...
             <span class={`text-[8px] font-black px-2 py-0.5 rounded-full border ${levelColors[classData?.level as keyof typeof levelColors] || levelColors.mixed}`}>
               {levelLabels[classData?.level as keyof typeof levelColors] || 'DESCONOCIDO'}
             </span>
          </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10" in:fly={{ y: 20 }}>
      ...
      <div class="lg:col-span-2 space-y-8">
        <section class="bento-card p-8 space-y-8 border-t-4 border-primary-500">
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-2">
              <div class="space-y-6">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Horario Semanal</p>
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Aula / Ubicación</p>
              ...
              <div class="space-y-6">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Periodo Lectivo</p>
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <p class="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1">Cuota Mensual</p>
           ...
           {#if classData?.description}
             <div class="bg-zinc-950/50 border border-zinc-900 p-6 rounded-2xl">
               <h3 class="text-[8px] font-black text-zinc-500 uppercase tracking-[0.2em] mb-3">Descripción General</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p class="text-zinc-500 text-[10px] font-black uppercase tracking-widest">Añadir nuevo registro</p>
          </button>

          <button 
            onclick={() => goto(`/panel/clases/${classData.id}/attendance`)}
            class="bento-card p-8 text-left hover:border-emerald-500/50 transition-all group relative overflow-hidden"
          >
            <div class="absolute -right-4 -bottom-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <ClipboardText weight="duotone" class="w-24 h-24 text-white" />
            </div>
            <ClipboardText weight="duotone" class="w-8 h-8 text-emerald-400 mb-4" />
            <h4 class="text-white font-black uppercase text-sm mb-1">Tomar Asistencia</h4>
            <p class="text-zinc-500 text-[10px] font-black uppercase tracking-widest">Pasar lista hoy</p>
          </button>
        </div>
      </div>
      ...
      <div class="space-y-8">
        ...
        <div class="bento-card p-8 space-y-6">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="bg-zinc-950 p-4 rounded-2xl border border-zinc-900 text-center">
               <p class="text-[8px] font-black text-zinc-500 uppercase mb-1">Activos</p>
               <p class="text-xl font-black text-white">{classStats.active_students}</p>
            </div>
            <div class="bg-zinc-950 p-4 rounded-2xl border border-zinc-900 text-center">
               <p class="text-[8px] font-black text-zinc-500 uppercase mb-1">Libres</p>
        ...
        <div class="bento-card p-8 space-y-6">
           ...
           <div class="space-y-4 font-body text-sm">
              <div class="flex items-center justify-between py-2 border-b border-zinc-900">
                <span class="text-[10px] font-black text-zinc-500 uppercase">Promedio</span>
                <span class="text-xs font-black text-emerald-400">{attendanceStats.average_attendance_rate}%</span>
              </div>
              <div class="flex items-center justify-between py-2 border-b border-zinc-900">
                <span class="text-[10px] font-black text-zinc-500 uppercase">Puntualidad</span>
                <span class="text-xs font-black text-blue-400">{attendanceStats.average_punctuality_rate}%</span>
              </div>
              <div class="flex items-center justify-between py-2">
                <span class="text-[10px] font-black text-zinc-500 uppercase">Última Sesión</span>
        ...
        <div class="p-8 border-2 border-primary-500/20 rounded-3xl bg-primary-500/5 text-center space-y-2">
           ...
           <p class="text-[10px] text-zinc-500 font-bold leading-relaxed uppercase tracking-wider">Este grupo ha completado el 45% de las habilidades programadas.</p>
        </div>
      </div>
    </div>
      ...
      {#if students.length === 0}
         <div class="bento-card p-20 text-center space-y-6 border-dashed">
            ...
            <div class="space-y-2">
              ...
              <p class="text-zinc-500 text-xs font-medium uppercase tracking-widest">Comienza por añadir tu primer estudiante a este grupo.</p>
            </div>
            <button 
               ...
               <div class="bento-card p-6 hover:border-primary-500/30 transition-all group">
                  <div class="flex items-center gap-4 mb-6">
                     ...
                     <div>
                        ...
                        <p class="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">{student.age} años • {levelLabels[student.level as keyof typeof levelLabels] || 'MIXTO'}</p>
                     </div>
                  </div>
                  ...
                  <div class="space-y-3 pb-6 border-b border-zinc-900 mb-6 font-body">
                     <div class="flex items-center gap-3 text-zinc-400">
                        ...
                        <span class="text-[10px] font-bold truncate uppercase tracking-wider">{student.email || 'SIN EMAIL'}</span>
                     </div>
                     <div class="flex items-center gap-3 text-zinc-400">
                        <Phone weight="duotone" class="w-3.5 h-3.5 text-primary-500/50" />
                        <span class="text-[10px] font-bold uppercase tracking-wider">{student.phone || 'SIN TELÉFONO'}</span>
                     </div>
                  </div>

                  <div class="flex items-center justify-between">
                     <div class="flex items-center gap-2">
                        <div class={`w-1.5 h-1.5 rounded-full ${student.active ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-zinc-800'}`}></div>
                        <span class="text-[10px] font-black uppercase tracking-widest text-zinc-500">{student.active ? 'ACTIVO' : 'INACTIVO'}</span>
                     </div>
                     <button 
      ...
      {#if classSkills.length === 0}
         <div class="bento-card p-20 text-center space-y-6 border-dashed">
            ...
            <div class="space-y-2">
              ...
              <p class="text-zinc-500 text-xs font-medium uppercase tracking-widest">Asigna habilidades del currículo de ChessNet a esta clase.</p>
            </div>
         </div>
      {:else}
         <div class="space-y-4">
