<script lang="ts">
  ...
  const validateForm = () => {
    ...
    if (!formData.name.trim()) newErrors.name = 'El nombre de la clase es obligatorio';
    if (!formData.school_id) newErrors.school_id = 'Debes seleccionar un centro educativo';
    errors = newErrors;
            ...
            <div class="space-y-2">
              ...
              <div class="relative group">
                <input
                  ...
                  placeholder="Ej: Avanzado Lunes 17:00"
          ...
          <div class="space-y-6">
            <div class="space-y-2 group">
              ...
              <p class="text-xs text-zinc-500 leading-relaxed font-jakarta pl-3.5">
                Utiliza nombres descriptivos como <span class="text-zinc-300">"Iniciación A - Miércoles"</span> para que el filtrado sea más sencillo después.
              </p>
            </div>
            ...
            <div class="space-y-2 group">
              ...
              <p class="text-xs text-zinc-500 leading-relaxed font-jakarta pl-3.5">
                Al asignar un centro, la clase heredará automáticamente el sistema de evaluación y competencias de dicho centro.
              </p>
            </div>
          </div>
        </div>
