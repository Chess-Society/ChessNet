<script lang="ts">
  ...
  // Métricas financieras calculadas con derived
  ...
  const addPayment = () => {
    ...
    showModal = false;
    newPayment = { student_id: '', amount: 0, paid_date: new Date().toISOString().split('T')[0], concept: 'Cuota Mensual' };
  };

</script>

<svelte:head>
  <title>Pagos y Finanzas - ChessNet</title>
</svelte:head>
...
<div class="max-w-7xl mx-auto px-6 pb-20" transition:fade>
  ...
  <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-12 pt-10">
    <div class="space-y-4">
      <div class="flex items-center gap-5">
        ...
        <div>
          <h1 class="text-4xl font-outfit font-black text-white tracking-tight uppercase leading-none">Finanzas Hub</h1>
          <p class="text-slate-500 font-jakarta text-sm mt-2 tracking-wide font-medium">Control total de ingresos y facturación de la academia.</p>
        </div>
      </div>
    </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
     ...
     <div class="bento-card p-8 group">
        ...
        <p class="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mb-4 font-jakarta relative z-10">Ingresos este mes</p>
        ...
        <div class="flex items-center gap-2 mt-6 relative z-10">
          <div class="flex items-center gap-1 bg-emerald-500/10 text-emerald-400 px-3 py-1 rounded-full text-[10px] font-black border border-emerald-500/20">
            <ArrowUpRight size={12} weight="bold" /> {metrics.growth}%
          </div>
          <span class="text-[9px] text-slate-500 font-bold uppercase tracking-widest">vs mes pasado</span>
        </div>
     </div>
     ...
     <div class="bento-card p-8 group">
        ...
        <p class="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mb-4 font-jakarta relative z-10">Ticket Promedio</p>
        <div class="flex items-baseline gap-1 relative z-10">
        ...
        <p class="text-[9px] text-slate-500 mt-6 font-bold uppercase tracking-widest relative z-10">Basado en {metrics.totalCount} transacciones</p>
     </div>
     ...
     <div class="bento-card p-8 group">
        ...
        <p class="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mb-4 font-jakarta relative z-10">Estado Cartera</p>
        ...
        <div class="flex items-center gap-2 mt-6 relative z-10">
            ...
            <span class="text-[9px] text-emerald-400 font-black uppercase tracking-widest">Cobros al día</span>
        </div>
     </div>
     ...
     <div class="bento-card p-8 border-violet-500/30 bg-gradient-to-br from-violet-600/10 to-transparent">
        <div class="flex items-center justify-between mb-4">
            <p class="text-violet-400 text-[10px] font-black uppercase tracking-[0.2em] font-jakarta">Suscripción SaaS</p>
        ...
        <p class="text-2xl font-outfit font-black text-white mb-1 uppercase tracking-tight">Maestro Premium</p>
  ...
  <div class="flex flex-col md:flex-row gap-4 mb-8">
      <div class="relative flex-1 group">
        ...
        <input
          type="text"
          placeholder="Buscar transacciones por alumno..."
      ...
      <button class="px-6 py-5 bg-white/[0.03] border border-white/10 rounded-[20px] text-slate-400 hover:text-white hover:bg-white/[0.08] transition-all flex items-center justify-center gap-3">
          ...
          <span class="text-xs font-black uppercase tracking-widest">Filtros Avanzados</span>
      </button>
  </div>
          ...
          <table class="w-full text-left border-collapse font-jakarta">
              <thead>
                  <tr class="bg-white/[0.02] border-b border-white/5">
                      <th class="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Competidor</th>
                      <th class="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Referencia / Concepto</th>
                      <th class="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Fecha Contable</th>
                      <th class="px-10 py-6 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] text-right">Monto</th>
                  </tr>
              </thead>
                      ...
                      <tr>
                          <td colspan="4" class="px-10 py-32 text-center" in:fade>
                            <div class="flex flex-col items-center gap-4 opacity-20">
                                ...
                                <p class="text-sm font-black uppercase tracking-widest">Sin transacciones registradas</p>
                            </div>
                          </td>
                      </tr>
                  {:else}
                          ...
                          <tr class="hover:bg-white/[0.015] transition-all group cursor-pointer" in:fly={{ y: 10, duration: 400 }}>
                              <td class="px-10 py-6">
                                  <div class="flex items-center gap-4">
                                      ...
                                      <div>
                                          ...
                                          <p class="text-[9px] text-slate-600 font-black uppercase tracking-widest mt-0.5">Alumno Activo</p>
                                      </div>
                                  </div>
                              </td>
                              <td class="px-10 py-6">
                              ...
                              <td class="px-10 py-6">
                                  <div class="flex items-center gap-3">
                                      ...
                                      <span class="text-xs text-slate-500 font-bold uppercase tracking-widest">{new Date(p.paid_date || '').toLocaleDateString('es-ES', { day: '2-digit', month: 'short', year: 'numeric' })}</span>
                                  </div>
                              </td>
                              <td class="px-10 py-6 text-right">
                                  <div class="flex flex-col items-end">
                                      ...
                                      <span class="text-[9px] font-black text-emerald-500/60 uppercase tracking-widest">Completado</span>
                                  </div>
                              </td>
                          </tr>
                      {/each}
        ...
        >
            ...
            <div class="p-10 border-b border-white/5 flex justify-between items-center bg-white/[0.02] relative z-10">
                <div class="flex items-center gap-5">
                    ...
                    <div>
                      <h3 class="text-2xl font-outfit font-black text-white tracking-tight uppercase">Registrar Cobro</h3>
                      <p class="text-slate-500 text-[10px] font-black uppercase tracking-widest mt-1">Ingresa los detalles contables.</p>
                    </div>
                </div>
                <button 
            ...
            <div class="p-10 space-y-8 font-jakarta relative z-10">
                <div class="space-y-3">
                    <label for="student-select" class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2">Seleccionar Competidor</label>
                    <div class="relative group">
                      ...
                      >
                          <option value="" class="bg-[#121214]">ELEGIR ALUMNO...</option>
                          {#each students as s}
                ...
                <div class="grid grid-cols-2 gap-8">
                    <div class="space-y-3">
                        <label for="payment-amount" class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2">Monto Neto (€)</label>
                        <div class="relative group">
                          ...
                          <input 
                            ...
                            class="w-full bg-white/5 border border-white/10 rounded-[20px] pl-16 pr-6 py-5 text-sm font-bold text-white focus:border-primary-500/50 focus:ring-4 focus:ring-primary-500/5 outline-none transition-all text-primary-400 placeholder:text-slate-800" 
                            placeholder="0.00"
                          />
                        </div>
                    </div>
                    <div class="space-y-3">
                        <label for="payment-date" class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2">Fecha Contable</label>
                        <div class="relative group">
                          <input 
                            id="payment-date" 
                            type="date" 
                ...
                <div class="space-y-3">
                    <label for="payment-concept" class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-2">Concepto de Facturación</label>
                    <div class="relative group">
                        ...
                        placeholder="EJ: MENSUALIDAD SEPTIEMBRE"
                        />
                    </div>
                </div>
