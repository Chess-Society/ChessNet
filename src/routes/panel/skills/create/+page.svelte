...
<form method="POST" use:enhance class="min-h-screen bg-zinc-950 text-white pb-32" in:fade>
  <!-- Premium Top Bar -->
    ...
    <div class="max-w-[1200px] mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        >
          ...
          {/if}
          {$delayed ? $t('skills.create.saving') : $t('skills.create.save_btn')}
        </button>
      </div>
    </div>
  </header>
                ...
                {#each availablePrerequisites as skill}
                  ...
                  >
                    <div class="w-10 h-10 rounded-none flex items-center justify-center transition-all
                      {$form.prerequisites.includes(skill.id) ? 'bg-violet-600 text-white shadow-lg shadow-violet-600/20' : 'bg-zinc-900 text-zinc-700 group-hover/req:text-zinc-500'}">
           ...
           <div class="space-y-6 pt-6 border-t border-zinc-800/50 relative z-10 font-bold">
              <div class="flex items-center justify-between">
                ...
                <button 
                  ...
                  {$form.active ? 'bg-violet-600 shadow-violet-600/20' : 'bg-zinc-800'}"
                >
              ...
              <div class="space-y-4">
                 <div class="flex items-center justify-between text-xs">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <span class="w-10 text-center font-black text-violet-400 tabular-nums">{$form.orderIndex}</span>
        ...
        <section in:fade class="bg-gradient-to-br from-zinc-900 to-black border border-white/5 rounded-none p-8 text-white space-y-8 shadow-2xl relative overflow-hidden group">
          ...
          <div class="pt-6 border-t border-white/5 relative z-10 flex items-center justify-between">
            <div class="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-zinc-500 group-hover:text-zinc-300 transition-colors">
              <Clock weight="fill" class="w-4 h-4 text-violet-500" /> {$form.estimatedHours} {$t('common.duration_unit') || 'Hours'}
            </div>
...
<style>
  ...
  .glass-input {
    @apply w-full bg-zinc-950/50 border border-zinc-800/50 rounded-none px-5 py-4 text-sm text-white focus:border-violet-500/50 focus:bg-zinc-900/50 outline-none transition-all placeholder:text-zinc-700 font-medium shadow-inner;
  }
  ...
  .selection-card.active {
    @apply bg-violet-600/10 border-violet-500/50 ring-1 ring-violet-500/20 shadow-lg shadow-violet-600/5;
  }
  ...
  .selection-card.active .card-icon {
    @apply bg-violet-600 text-white border-violet-400 shadow-lg shadow-violet-600/20;
  }
  ...
  .card-check {
    @apply absolute top-3 right-3 w-5 h-5 bg-violet-600 text-white rounded-none flex items-center justify-center shadow-lg;
  }
