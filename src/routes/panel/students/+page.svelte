  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-10">
    <div class="md:col-span-7 relative group">
      ...
      <input
        ...
        class="w-full bg-zinc-900/50 border border-white/5 rounded-2xl pl-16 pr-6 py-4 text-sm text-white focus:border-violet-500 outline-none transition-all backdrop-blur-xl font-jakarta placeholder:text-slate-600"
      />
    </div>
    ...
    <div class="md:col-span-3 relative group">
      ...
      <select 
        ...
        class="w-full bg-zinc-900/50 border border-white/5 rounded-2xl pl-16 pr-10 py-4 text-sm text-white focus:border-violet-500 outline-none transition-all appearance-none cursor-pointer backdrop-blur-xl font-jakarta"
      >
    ...
    <div class="md:col-span-2">
      <button 
        ...
        class="w-full h-full bg-white/5 border border-white/10 text-white px-6 py-4 rounded-2xl text-sm font-bold hover:bg-white/10 transition-all backdrop-blur-xl font-outfit uppercase tracking-widest"
      >
        Limpiar
      </button>
    </div>
