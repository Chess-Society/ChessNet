...
<svelte:head>
  <title>Edit Student - {studentData?.name} - ChessNet</title>
</svelte:head>
  ...
  <div class="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12 pt-8">
    <div class="space-y-4">
      ...
      <div class="flex items-center gap-6">
        ...
        <div>
          <h1 class="text-4xl md:text-5xl font-outfit font-extrabold text-white tracking-tighter">Edit Student</h1>
          <p class="text-slate-400 font-jakarta text-lg font-medium tracking-tight">Refine your student's profile.</p>
        </div>
      </div>
    </div>
    ...
    <div class="lg:col-span-8 space-y-8">
      <section class="bento-card p-10 space-y-10 relative overflow-hidden group">
        ...
        <div class="flex items-center gap-4 border-b border-white/5 pb-8 relative z-10">
           ...
           <h2 class="text-2xl font-outfit font-bold text-white tracking-tight">Personal Information</h2>
        </div>

        <div class="grid grid-cols-1 gap-10 relative z-10">
           <div class="space-y-4">
              <label for="name" class="text-[10px] font-outfit font-black text-slate-500 uppercase tracking-widest ml-1">Full Name for Lists</label>
              <div class="relative">
                <input
                  id="name"
                  type="text"
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div class="space-y-4">
                 <label for="first_name" class="text-[10px] font-outfit font-black text-slate-500 uppercase tracking-widest ml-1">First Name</label>
                 <input
                   id="first_name"
                   type="text"
              ...
              <div class="space-y-4">
                 <label for="last_name" class="text-[10px] font-outfit font-black text-slate-500 uppercase tracking-widest ml-1">Last Names</label>
                 <input
                   id="last_name"
                   type="text"
      ...
      <section class="bento-card p-10 space-y-10">
         <div class="flex items-center gap-4 border-b border-white/5 pb-8">
            ...
            <h2 class="text-2xl font-outfit font-bold text-white tracking-tight">Academic Remarks</h2>
         </div>

         <div class="space-y-4">
            <label for="notes" class="text-[10px] font-outfit font-black text-slate-500 uppercase tracking-widest ml-1 text-right block">Private Instructor Notes</label>
            <textarea
              id="notes"
              bind:value={formData.notes}
              placeholder="Record their playing style, favorite openings, or strategic evolution..."
    ...
    <div class="lg:col-span-4 space-y-8">
       <section class="bento-card p-8 space-y-8 border-t-2 border-violet-500 bg-gradient-to-b from-violet-600/5 to-transparent">
          <div class="flex items-center gap-4">
             ...
             <h3 class="text-lg font-outfit font-bold text-white tracking-tight">Educational School</h3>
          </div>
          ...
          <div class="space-y-6">
             ...
             <div class="p-5 bg-white/5 rounded-24 border border-white/5 border-dashed">
                <p class="text-[11px] font-jakarta font-medium text-slate-500 leading-relaxed italic text-center">
                   Linking to a school allows organizing students by specific levels and generating automatic institutional reports.
                </p>
             </div>
          </div>
       </section>
       ...
       <section class="bento-card p-8 space-y-6">
          <h3 class="text-[10px] font-outfit font-black text-slate-500 uppercase tracking-widest border-b border-white/5 pb-4">Real-time Preview</h3>
          ...
          <div class="flex items-center gap-5 bg-zinc-950/50 p-6 rounded-24 border border-white/5">
             ...
             <div class="min-w-0">
                <p class="text-base font-outfit font-bold text-white uppercase tracking-tight truncate">{formData.name || 'Unnamed Student'}</p>
                <div class="flex items-center gap-2 mt-1">
                   <CheckCircle size={14} weight="fill" class="text-primary-500" />
                   <p class="text-[10px] font-outfit font-bold text-slate-500 uppercase tracking-widest">Synchronized</p>
                </div>
             </div>
          </div>
       </section>
