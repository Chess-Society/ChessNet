<script lang="ts">
  ...
  const partners = [
    { name: 'Rexher Cup', logo: '/images/mindchess-logo.png', desc: 'Socio oficial de torneos élite' },
    { name: 'MindChess App', logo: '/images/rexher-cup-logo.png', desc: 'Plataforma líder en entrenamiento mental' }
  ];
</script>
